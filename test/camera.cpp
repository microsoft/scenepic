...
int test_camera()
{
    ...
    test::assert_equal(look_at_cam.world_to_camera(), world_to_camera, result, "world_to_camera");
    test::assert_equal(look_at_cam.camera_to_world(), camera_to_world, result, "camera_to_world");
    test::assert_near(look_at_cam.aspect_ratio(), initial_aspect_ratio, result, "aspect_ratio");
    test::assert_allclose(look_at_cam.projection(), projection, result, "projection");
    ...
    test::assert_equal(rt_camera.world_to_camera(), world_to_camera, result, "world_to_camera");
    test::assert_equal(rt_camera.camera_to_world(), camera_to_world, result, "camera_to_world");
    test::assert_near(rt_camera.aspect_ratio(), new_aspect_ratio, result, "aspect_ratio");
    ...
    test::assert_equal(camera.world_to_camera(), world_to_camera, result, "world_to_camera");
    test::assert_equal(camera.camera_to_world(), camera_to_world, result, "camera_to_world");
    test::assert_near(camera.aspect_ratio(), new_aspect_ratio, result, "aspect_ratio");
