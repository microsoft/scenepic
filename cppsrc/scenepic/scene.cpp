...
namespace scenepic
{
    ...
    std::shared_ptr<Canvas3D> Scene::create_canvas_3d(const std::string &canvas_id_init,
                                                      double width,
                                                      double height,
    ...
    std::shared_ptr<Canvas2D> Scene::create_canvas_2d(const std::string &canvas_id_init,
                                                      double width,
                                                      double height,
                                                      const std::string &html_id,
    ...
    std::shared_ptr<Graph> Scene::create_graph(const std::string &canvas_id_init,
                                               double width,
                                               double height,
                                               const std::string &html_id,
                                               const Color &background_color,
    ...
    std::shared_ptr<AudioTrack> Scene::create_audio(const std::string &audio_id_init)
    {
    ...
    std::shared_ptr<Mesh> Scene::create_mesh(const std::string &mesh_id_init,
                                                                   ...
                                                                   const std::string &mesh_id_init)
    {
        ...
        VectorBuffer normals = Mesh::compute_normals(positions, base_mesh->triangles());
    ...
    std::shared_ptr<Label> Scene::create_label(const std::string &label_id_init,
    ...
    std::shared_ptr<TextPanel> Scene::create_text_panel(const std::string &text_panel_id_init,
                                                        const std::string &html_id,
                                                        bool add_input_box)
    {
    ...
    std::shared_ptr<DropDownMenu> Scene::create_drop_down_menu(const std::string &drop_down_menu_id_init,
    ...
    void _measure_commands(std::map<std::string, std::size_t> &command_sizes, Json::Value commands)
    {
    ...
    void Scene::save_as_script(const std::string &path) const
    {
        std::ofstream output(path);
        output << this->script();
    }
                             ...
                             const std::string &body_html)
    {
        ...
        html << "<!DOCTYPE html>" << std::endl
             ...
             << "      <script" << path_to_lib << ">" << lib << "</script>" << std::endl
