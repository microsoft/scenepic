...
Graph::Margin::Margin(double top, double right, double bottom, double left) : top(top), right(right), bottom(bottom), left(left) {}
...
Graph::Sparkline::Sparkline(const std::string &name, const ValueBuffer &values, const Color &color, float line_width) : m_name(name), m_values(values), m_color(color), m_line_width(line_width)
{
}
