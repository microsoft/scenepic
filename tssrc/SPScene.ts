...
export default class SPScene
{
    ...
    private HandlePointerMove(event : PointerEvent)
    {
        ...
        // To deal with pointer-lock. Check if the event's movement property doesn't match deltaX/Y. If not, use movement X/Y instead.
        // DISABLED: This is not robust and breaks other 2D interation.
        // TODO: fix
        // if ((newX - oldX) != event.movementX || (newY - oldY) != event.movementY)
        // {
        //     deltaX = newX = event.movementX;
        //     deltaY = newY = event.movementY;
        //     oldX = oldY = 0;
        // }
